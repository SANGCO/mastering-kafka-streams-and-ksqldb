...
public class DigitalTwinFlatValueTransformer
        implements ValueTransformer<TurbineState, Iterable<DigitalTwin>> {
    ...
    */
    ...
    @Override
    public Iterable<DigitalTwin> transform(TurbineState value) {
