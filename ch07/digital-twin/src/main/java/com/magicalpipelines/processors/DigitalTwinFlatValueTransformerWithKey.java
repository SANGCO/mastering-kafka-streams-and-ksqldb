...
public class DigitalTwinFlatValueTransformerWithKey
        implements ValueTransformerWithKey<String, TurbineState, Iterable<DigitalTwin>> {
    ...
    */
    ...
    @Override
    public Iterable<DigitalTwin> transform(String key, TurbineState value) {
