...
public class DigitalTwinFlatTransformer
        implements Transformer<String, TurbineState, Iterable<KeyValue<String, DigitalTwin>>> {
    ...
    */
    ...
    @Override
    public Iterable<KeyValue<String, DigitalTwin>> transform(String key, TurbineState value) {
        ...
        return Collections.singletonList(KeyValue.pair(key, digitalTwin));
    }
